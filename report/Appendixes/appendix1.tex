%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  appendix1.tex  --  Source Code (main excerpts)
...
This appendix presents the core predicates of each project module.
The complete source code is available in the project repository.

% -------------------------------------------------------------------
\section{board.pl --- Board}

\begin{lstlisting}[language=Prolog,
    caption={board.pl --- board creation and manipulation},
...
% -------------------------------------------------------------------
\section{rules.pl --- Game Rules}

\begin{lstlisting}[language=Prolog,
    caption={rules.pl --- move validation and application},
...
% -------------------------------------------------------------------
\section{ai.pl --- Alpha-Beta Algorithm}

\begin{lstlisting}[language=Prolog,
    caption={ai.pl --- entry point and alpha-beta search},
    label={lst:ai_full},
    numbers=left,
    basicstyle=\footnotesize\ttfamily,
    frame=single]
